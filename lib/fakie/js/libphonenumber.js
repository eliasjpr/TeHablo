...
!COMPILED && goog.ENABLE_DEBUG_LOADER && (goog.included_ = {}, goog.dependencies_ = {pathToNames: {}, nameToPath: {}, requires: {}, visited: {}, written: {}}, goog.inHtmlDocument_ = function () {
    ...
    if (goog.global.CLOSURE_BASE_PATH)goog.basePath = goog.global.CLOSURE_BASE_PATH; else if (goog.inHtmlDocument_())for (var a = goog.global.document.getElementsByTagName("script"), b = a.length - 1; 0 <= b; --b) {
        var c = a[b].src, d = c.lastIndexOf("?"), d =
            -1 == d ? c.length : d;
    ...
    for (var b = this.getDescriptor().getFields(), c = 0; c < b.length; c++) {
        ...
        if (this.has(d)) {
            ...
            if (d.isRepeated()) {
                ...
                for (d = 0; d < f.length; d++)if (!(e ? f[d].equals(g[d]) : f[d] == g[d]))return!1
            } else if (!(e ? f.equals(g) : f == g))return!1
        }
    }
    return!0
};
...
goog.proto2.Message.prototype.mergeFrom = function (a) {
    ...
    for (var b = this.getDescriptor().getFields(), c = 0; c < b.length; c++) {
        ...
        if (a.has(d)) {
            ...
            if (d.isRepeated())for (var f = a.arrayOf(d), g = 0; g < f.length; g++)this.add(d, e ? f[g].clone() : f[g]); else f = a.getValueForField_(d), e ? (e = this.getValueForField_(d)) ? e.mergeFrom(f) :
                this.set(d, f.clone()) : this.set(d, f)
        }
    }
};
...
goog.proto2.Message.prototype.initDefaults = function (a) {
    for (var b = this.getDescriptor().getFields(), c = 0; c < b.length; c++) {
        ...
        if (f)if (d.isRepeated()) {
            d = this.array$Values(e);
            for (e = 0; e < d.length; e++)d[e].initDefaults(a)
...
goog.proto2.Message.prototype.has$Value = function (a) {
    goog.proto2.Util.assert(this.fields_[a], "No field found for the given tag");
    return a in this.values_ && goog.isDef(this.values_[a]) && null !== this.values_[a]
};
goog.proto2.Message.prototype.getValueForField_ = function (a) {
    var b = a.getTag();
    if (!b in this.values_)return null;
    var c = this.values_[b];
    return null == c ? null : this.lazyDeserializer_ ? !(b in this.deserializedFields_) ? (a = this.lazyDeserializer_.deserializeField(this, a, c), this.deserializedFields_[b] = a) : this.deserializedFields_[b] : c
};
goog.proto2.Message.prototype.get$Value = function (a, b) {
    var c = this.getFieldByTag_(a), d = this.getValueForField_(c);
    if (c.isRepeated())return goog.proto2.Util.assert(goog.isArray(d)), c = b || 0, goog.proto2.Util.assert(0 <= c && c < d.length, "Given index is out of bounds"), d[c];
    goog.proto2.Util.assert(!goog.isArray(d));
    return d
};
goog.proto2.Message.prototype.get$ValueOrDefault = function (a, b) {
    return!this.has$Value(a) ? this.getFieldByTag_(a).getDefaultValue() : this.get$Value(a, b)
};
...
goog.proto2.Message.prototype.checkFieldType_ = function (a, b) {
    ...
    c === String ? goog.proto2.Util.assert("string" === typeof b, "Expected value of type string") : c === Boolean ? goog.proto2.Util.assert("boolean" === typeof b, "Expected value of type boolean") : c === Number ? goog.proto2.Util.assert("number" === typeof b, "Expected value of type number") : a.getFieldType() == goog.proto2.FieldDescriptor.FieldType.ENUM ? goog.proto2.Util.assert("number" === typeof b, "Expected an enum value, which is a number") :
        goog.proto2.Util.assert(b instanceof c, "Expected a matching message type")
};
...
goog.proto2.Message.create$Descriptor = function (a, b) {
    var c = [], d, e;
    for (e in b)b.hasOwnProperty(e) && (goog.proto2.Util.assert(goog.string.isNumeric(e), "Keys must be numeric"), 0 == e ? d = b[0] : c.push(new goog.proto2.FieldDescriptor(a, e, b[e])));
...
goog.proto2.ObjectSerializer.prototype.deserializeTo = function (a, b) {
    ...
    for (d in b) {
        ...
        if (e)if (e.isRepeated()) {
            goog.proto2.Util.assert(goog.isArray(f));
            for (g = 0; g < f.length; g++)a.add(e, this.getDeserializedValue(e, f[g]))
        } else goog.proto2.Util.assert(!goog.isArray(f)), a.set(e, this.getDeserializedValue(e, f)); else g ?
...
i18n.phonenumbers.metadata.countryToMetadata = {AC: [
    ,
    [, , "[2-467]\\d{3}", "\\d{4}"],
    ...
    [
        ...
        [, "(\\d{3})(\\d{3})(\\d{4})", "$1 $2-$3", ["2(?:2[013]|3[067]|49|6[01346]|80|9[147-9])|3(?:36|4[12358]|5[138]|6[24]|7[069]|8[013578])", "2(?:2[013]|3[067]|49|6[01346]|80|9(?:[17-9]|4[13479]))|3(?:36|4[12358]|5(?:[18]|3[0-689])|6[24]|7[069]|8(?:[01]|3[013469]|5[0-39]|7[0-2459]|8[0-49]))"], "0$1", "",
            0],
        [, "(\\d{4})(\\d{3})(\\d{3})", "$1 $2-$3", ["3(?:53|8[78])", "3(?:537|8(?:73|88))"], "0$1", "", 0],
        [, "(\\d{4})(\\d{2})(\\d{4})", "$1 $2-$3", ["[23]"], "0$1", "", 0]
    ],
    [
        ...
        [, "(9)(\\d{4})(\\d{3})(\\d{3})", "$2 15-$3-$4", "93[58] 9(?:3(?:53|8[78])) 9(?:3(?:537|8(?:73|88))) 93[58] 9(?:3(?:53|8[78])) 9(?:3(?:537|8(?:73|88)))".split(" "), "0$1", "", 0],
        [, "(9)(\\d{4})(\\d{2})(\\d{4})", "$1 $2 $3-$4", ["9[23]"]],
        [, "(11)(\\d{4})(\\d{4})", "$1 $2-$3", ["1", "1"], "0$1", "", 0],
        [, "(\\d{3})(\\d{3})(\\d{4})", "$1 $2-$3", ["2(?:2[013]|3[067]|49|6[01346]|80|9[147-9])|3(?:36|4[12358]|5[138]|6[24]|7[069]|8[013578])", "2(?:2[013]|3[067]|49|6[01346]|80|9(?:[17-9]|4[13479]))|3(?:36|4[12358]|5(?:[18]|3[0-689])|6[24]|7[069]|8(?:[01]|3[013469]|5[0-39]|7[0-2459]|8[0-49]))",
            "2(?:2[013]|3[067]|49|6[01346]|80|9[147-9])|3(?:36|4[12358]|5[138]|6[24]|7[069]|8[013578])", "2(?:2[013]|3[067]|49|6[01346]|80|9(?:[17-9]|4[13479]))|3(?:36|4[12358]|5(?:[18]|3[0-689])|6[24]|7[069]|8(?:[01]|3[013469]|5[0-39]|7[0-2459]|8[0-49]))"], "0$1", "", 0],
        [, "(\\d{4})(\\d{3})(\\d{3})", "$1 $2-$3", ["3(?:53|8[78])", "3(?:537|8(?:73|88))", "3(?:53|8[78])", "3(?:537|8(?:73|88))"], "0$1", "", 0],
        [, "(\\d{4})(\\d{2})(\\d{4})", "$1 $2-$3", ["[23]", "[23]"], "0$1", "", 0]
    ],
    [, , "NA", "NA"],
    ,
    ,
    ...
    [
        ...
        [, "(\\d{4})(\\d{3,9})", "$1 $2", ["2|3(?:1[1-578]|[3-8])|4[2378]|5[2-6]|6(?:[12]|4[1-35-9]|5[468])|7(?:2[1-8]|35|4[1-8]|[57-9])"], "0$1", "", 0]
    ],
    ,
    [, , "NA", "NA"],
    ,
    ...
    ,
    [, , "[135]\\d{5,9}|[27]\\d{4,9}|4\\d{5,10}|6\\d{7,8}|8\\d{6,9}", "\\d{5,12}"],
    ...
    ,
    [
        [, "(4[6-9]\\d)(\\d{2})(\\d{2})(\\d{2})", "$1 $2 $3 $4", ["4[6-9]"], "0$1", "", 0],
        [, "([2-49])(\\d{3})(\\d{2})(\\d{2})", "$1 $2 $3 $4", ["[23]|[49][23]"], "0$1", "", 0],
        [, "([15-8]\\d)(\\d{2})(\\d{2})(\\d{2})", "$1 $2 $3 $4", ["[156]|7[0178]|8(?:0[1-9]|[1-79])"], "0$1", "", 0],
    ...
    [
        ...
        [, "(\\d{2})(\\d{3})(\\d{2,3})", "$1 $2 $3", ["[356]|7[1-9]|8[1-6]|9[1-7]"], "0$1", "", 0],
    ...
    [, , "(?:3(?:[23469]\\d|5[35]|77|8[348])\\d|6(?:1[16]\\d|3(?:00|33|6[16])|6(?:[069]\\d|3[03-9]|44)|9(?:69|9[6-9]))|77\\d{2})\\d{4}",
        "\\d{8}", , , "36001234"],
    [, , "80\\d{6}", "\\d{8}", , , "80123456"],
    ...
    [, , "(?:318[1456]|416[15-8]|7(?:0[01]|[89]\\d)\\d)\\d{3}|",
        "\\d{7}", , , "3181234"],
    [, , "NA", "NA"],
    [, , "NA", "NA"],
    [, , "NA", "NA"],
    ...
    [, , "1(?:1(?:5[347]|[6-9]\\d|)|[2-9][6-9]\\d)\\d{6}|(?:2[12478]|3[1-578]|[4689][1-9]|5[13-5]|7[13-579])[6-9]\\d{7}|(?:119\\d|1[2-9]9[6-9])\\d{7}",
        "\\d{10,11}", , , "1161234567"],
    ...
    [
        ...
        [, "(\\d{2})(\\d{5})(\\d{4})", "$1 $2-$3", ["1[1-9]9"], "($1)", "0 $CC ($1)", 0],
        [, "(\\d{2})(\\d{4})(\\d{4})",
    ...
    [
        [, "(\\d{2})(\\d{5})(\\d{4})", "$1 $2-$3", ["1[1-9]9", "1[1-9]9"], "($1)", "0 $CC ($1)", 0],
        [, "(\\d{2})(\\d{4})(\\d{4})", "$1 $2-$3", ["[1-9][1-9]", "[1-9][1-9]"], "($1)", "0 $CC ($1)", 0],
        [, "([34]00\\d)(\\d{4})", "$1-$2", ["[34]00", "[34]00"], "", "", 0],
        [, "([3589]00)(\\d{2,3})(\\d{4})", "$1 $2 $3", ["[3589]00", "[3589]00"], "0$1", "", 0]
    ],
    [, , "NA", "NA"],
    ,
    ,
    ...
    [, , "7(?:[1-35]\\d{6}|[46][0-7]\\d{5}|7[01]\\d{5})",
        "\\d{8}", , , "71123456"],
    [, , "NA", "NA"],
    [, , "90\\d{5}", "\\d{7}", , , "9012345"],
    [, , "NA", "NA"],
    ...
    [
        ...
        [, "([89]\\d{2})(\\d{3})(\\d{3})", "$1 $2 $3", ["8[0-259]|9"], "0$1", "", 0],
        [, "(\\d{2})(\\d{2})(\\d{3})", "$1 $2 $3", ["8[48]"], "0$1", "", 0],
    ...
    ,
    [, , "(?:[2-9]|600|123)\\d{7,8}", "\\d{6,11}"],
    [, , "(?:[23]2|41|58)\\d{7}|(?:3[3-5]|4[235]|5[1-357]|6[13-57]|7[1-35])\\d{6,7}",
        "\\d{6,9}", , , "221234567"],
    ...
    [
        ...
        [, "(\\d{2})(\\d{2,3})(\\d{4})", "$1 $2 $3", ["[357]|4[1-35]|6[13-57]"], "($1)",
            "$CC ($1)", 0],
    ...
    ,
    [
        [, "([237-9]\\d)(\\d{2})(\\d{2})(\\d{2})", "$1 $2 $3 $4", ["[2379]|88"], "", "", 0],
    ...
    ,
    [, , "[1-7]\\d{7,11}|8[0-357-9]\\d{6,9}|9(?:5\\d{3}|\\d{9})", "\\d{4,12}"],
    ...
    [
        ...
        [, "(\\d{5})", "$1", ["95", "95"], "", "", 0],
        [, "(21)(\\d{4})(\\d{4,6})", "$1 $2 $3", ["21", "21"], "0$1", "$CC $1", 1],
        [, "([12]\\d)(\\d{4})(\\d{4})", "$1 $2 $3", "10[1-9]|2[02-9] 10[1-9]|2[02-9] 10(?:[1-79]|8(?:[1-9]|0[1-9]))|2[02-9] 10[1-9]|2[02-9] 10[1-9]|2[02-9] 10(?:[1-79]|8(?:[1-9]|0[1-9]))|2[02-9]".split(" "),
            "0$1", "$CC $1", 1],
        [, "(\\d{3})(\\d{4})(\\d{4})", "$1 $2 $3", ["3(?:11|7[179])|4(?:[15]1|3[12])|5(?:1|2[37]|3[12]|51|7[13-79]|9[15])|7(?:31|5[457]|6[09]|91)|8(?:71|98)", "3(?:11|7[179])|4(?:[15]1|3[12])|5(?:1|2[37]|3[12]|51|7[13-79]|9[15])|7(?:31|5[457]|6[09]|91)|8(?:71|98)"], "0$1", "$CC $1", 1],
        [, "(\\d{3})(\\d{3})(\\d{4})", "$1 $2 $3", ["3(?:1[02-9]|35|49|5|7[02-68]|9[1-68])|4(?:1[02-9]|2[179]|[35][2-9]|6[4789]|7\\d|8[23])|5(?:3[03-9]|4[36]|5[02-9]|6[1-46]|7[028]|80|9[2-46-9])|6(?:3[1-5]|6[0238]|9[12])|7(?:01|[1579]|2[248]|3[04-9]|4[3-6]|6[2368])|8(?:1[236-8]|2[5-7]|3|5[1-9]|7[02-9]|8[3678]|9[1-7])|9(?:0[1-3689]|1[1-79]|[379]|4[13]|5[1-5])",
            "3(?:1[02-9]|35|49|5|7[02-68]|9[1-68])|4(?:1[02-9]|2[179]|[35][2-9]|6[4789]|7\\d|8[23])|5(?:3[03-9]|4[36]|5[02-9]|6[1-46]|7[028]|80|9[2-46-9])|6(?:3[1-5]|6[0238]|9[12])|7(?:01|[1579]|2[248]|3[04-9]|4[3-6]|6[2368])|8(?:1[236-8]|2[5-7]|3|5[1-9]|7[02-9]|8[3678]|9[1-7])|9(?:0[1-3689]|1[1-79]|[379]|4[13]|5[1-5])"], "0$1", "$CC $1", 1],
    ...
    [
        [, "(\\d)(\\d{7})", "$1 $2", ["1(?:8[2-9]|9[0-3]|[2-7])|[24-8]", "1(?:8[2-9]|9(?:09|[1-3])|[2-7])|[24-8]", "1(?:8[2-9]|9[0-3]|[2-7])|[24-8]", "1(?:8[2-9]|9(?:09|[1-3])|[2-7])|[24-8]"], "($1)", "0$CC $1", 0],
        [, "(\\d{3})(\\d{7})", "$1 $2", ["3",
            "3"], "", "0$CC $1", 0],
    ...
    [, , "NA", "NA"],
    [, , "NA", "NA"],
    [, , "210[0-6]\\d{4}|4(?:0(?:[04]0\\d{4}|10[0-3]\\d{3}|2(?:00\\d|900)\\d{2}|3[01]\\d{4}|5\\d{5}|70[01]\\d{3})|1[01]\\d{5}|20[0-3]\\d{4}|400\\d{4}|70[0-2]\\d{4})|5100\\d{4}",
        "\\d{8}", , , "40001234"],
    "CR",
    506,
    "00",
    ...
    ,
    [, , "[1-35-9]\\d{3,14}|4(?:[0-8]\\d{4,12}|9(?:[0-37]\\d|4(?:[1-35-8]|4\\d?)|5\\d{1,2}|6[1-8]\\d?)\\d{2,7})", "\\d{2,15}"],
    ...
    [
        ...
        [, "(\\d{2})(\\d{4,11})", "$1 $2", ["3[02]|40|[68]9"], "0$1", "", 0],
    ...
    [, , "1(?:0[01269]|1[1245]|2[0-278])\\d{7}", "\\d{10}", , , "1001234567"],
    [, , "800\\d{7}", "\\d{10}", , , "8001234567"],
    ...
    [
        ...
        [, "(\\d{2})(\\d{4,10})", "$1 $2", ["2[09]|[14]|50|7[135]"], "0$1", "", 0],
    ...
    ,
    [
        [, "(\\d{3})(\\d{2})(\\d{2})(\\d{2})", "$1 $2 $3 $4", ["[348]"], "8 $1", "", 0],
    ...
    ,
    [
        [, "(\\d{2})(\\d{2})(\\d{2})(\\d{2})", "$1 $2 $3 $4", ["[23567]"], "", "", 0],
        [, "(\\d{3})(\\d{2})(\\d{2})(\\d{2})", "$1 $2 $3 $4", ["6[02356]"], "", "", 0]
    ],
    ,
    [, , "NA", "NA"],
    ,
    ...
    ,
    [, , "[26-9]\\d{9}", "\\d{10}"],
    [, , "2(?:1\\d{2}|2(?:3[1-8]|4[1-7]|5[1-4]|6[1-8]|7[1-5]|[289][1-9])|3(?:1\\d|2[1-57]|3[1-4]|[45][1-3]|7[1-7]|8[1-6]|9[1-79])|4(?:1\\d|2[1-8]|3[1-4]|4[13-5]|6[1-578]|9[1-5])|5(?:1\\d|[239][1-4]|4[124]|5[1-6])|6(?:1\\d|3[124]|4[1-7]|5[13-9]|[269][1-6]|7[14]|8[1-5])|7(?:1\\d|2[1-5]|3[1-6]|4[1-7]|5[1-57]|6[134]|9[15-7])|8(?:1\\d|2[1-5]|[34][1-4]|9[1-7]))\\d{6}",
        "\\d{10}", , , "2123456789"],
    ...
    ,
    [, , "[237-9]\\d{7}", "\\d{8}"],
    [, , "2(?:2(?:0[019]|1[1-36]|[23]\\d|4[056]|5[57]|8[0146-9]|9[012])|4(?:2|3-59]|3[13-689]|4[0-68]|5[1-35])|5(?:4[3-5]|5\\d|6[56]|74)|6(?:4[0-378]|[56]\\d|[78][0-8]|9[01])|7(?:6[46-9]|7[02-9]|8[34])|8(?:79|8[0-35789]|9[1-57-9]))\\d{4}",
        "\\d{8}", , , "22123456"],
    ...
    [
        ...
        [, "(\\d{3})(\\d{3})(\\d{4})", "$1 $2 $3",
            ["7(?:12|2[14]|3[134]|4[47]|5[15]|[67]1|88)", "7(?:12|2[14]|3[134]|4[47]|5(?:1|5[2-6])|[67]1|88)"], "0$1", "", 1],
        [, "(\\d{3})(\\d{3})(\\d{4})", "$1 $2 $3", ["8(?:16|2[014]|3[126]|6[136]|7[078]|8[34]|91)"], "0$1", "", 1],
        [, "(\\d{4})(\\d{3})(\\d{3})", "$1 $2 $3", ["1(?:[2-579]|[68][1-9])|[2-8]"], "0$1", "", 1],
        [, "(1600)(\\d{2})(\\d{4})", "$1 $2 $3", ["160", "1600"], "$1", "", 0],
        [, "(1800)(\\d{4,5})", "$1 $2", ["180", "1800"], "$1", "", 0],
        [, "(18[06]0)(\\d{2,4})(\\d{4})", "$1 $2 $3", ["18[06]", "18[06]0"], "$1", "", 0],
        [, "(\\d{4})(\\d{3})(\\d{4})(\\d{2})",
            "$1 $2 $3 $4", ["18[06]", "18(?:03|6[12])"], "$1", "", 0]
    ],
    ,
    [, , "NA", "NA"],
    ,
    ...
    ,
    [, , "[14-8]\\d{6,9}|[23]\\d{5,9}|9(?:[1-4]\\d{8}|9\\d{2,8})", "\\d{4,10}"],
    ...
    [
        [, "(21)(\\d{3,5})",
            "$1 $2", ["21"], "0$1", "", 0],
        [, "(21)(\\d{3})(\\d{3,4})", "$1 $2 $3", ["21"], "0$1", "", 0],
        [, "(2[16])(\\d{4})(\\d{4})", "$1 $2 $3", ["2[16]"], "0$1", "", 0],
        [, "(\\d{3})(\\d{3})(\\d{3,4})", "$1 $2 $3", ["[13-9]|2[02-9]"], "0$1", "", 0]
    ],
    ,
    ...
    [, , "(?:4(?:[14][0-245]|2[0-7]|[37][0-8]|5[0-3568]|6\\d|8[0-36-8])|5(?:05|[156]\\d|2[02578]|3[013-7]|4[03-7]|7[0-2578]|8[0-35-9]|9[013-689])|87[23])\\d{4}",
        "\\d{7}", , , "4101234"],
    ...
    ,
    [, , "[1-9]\\d{8,9}|0(?:[36]\\d{7,14}|7\\d{5,7}|8\\d{7})", "\\d{7,16}"],
    ...
    [
        ...
        [, "(\\d{3})(\\d{3})(\\d{3,4})", "$1-$2-$3", ["0(?:37|66)"], "0$1", "", 0],
        ...
        [, "(\\d{4})(\\d)(\\d{4})", "$1-$2-$3",
            ["1(?:26|3[79]|4[56]|5[4-68]|6[3-5])|5(?:76|97)|499|746|8(?:3[89]|63|47|51)|9(?:49|80|9[16])", "1(?:267|3(?:7[247]|9[278])|4(?:5[67]|66)|5(?:47|58|64|8[67])|6(?:3[245]|48|5[4-68]))|5(?:76|97)9|499[2468]|7468|8(?:3(?:8[78]|96)|636|477|51[24])|9(?:496|802|9(?:1[23]|69))", "1(?:267|3(?:7[247]|9[278])|4(?:5[67]|66)|5(?:47|58|64|8[67])|6(?:3[245]|48|5[4-68]))|5(?:769|979[2-69])|499[2468]|7468|8(?:3(?:8[78]|96[2457-9])|636[2-57-9]|477|51[24])|9(?:496|802|9(?:1[23]|69))"], "0$1", "", 0],
        [, "(\\d{3})(\\d{2})(\\d{4})",
    ...
    [, , "5[124-7]\\d{7}|7(?:0[0-357-9]|7\\d)\\d{6}",
        "\\d{9}", , , "700123456"],
    ...
    ,
    [, , "[1-9]\\d{7,9}", "\\d{6,10}"],
    [, , "(?:2[3-6]|3[2-6]|4[2-4]|[567][2-5])(?:[2-47-9]|5\\d|6\\d?)\\d{5}",
        "\\d{6,9}", , , "23456789"],
    ...
    [
        ...
        [, "(\\d{2})(\\d{3,4})(\\d{4})", "$1-$2-$3", ["1(?:[169][2-8]|[78]|5[1-4])|[68]0|[3-6][1-9][1-9]",
            "1(?:[169][2-8]|[78]|5(?:[1-3]|4[56]))|[68]0|[3-6][1-9][1-9]"], "0$1", "0$CC-$1", 0],
    ...
    ,
    [, , "(?:[29]\\d|[4-6]|7\\d{1,2}|[38]\\d{2})\\d{6}", "\\d{7,9}"],
    [, , "2\\d{7}", "\\d{8}", , , "21234567"],
    ...
    [
        [, "([34]\\d)(\\d{6})",
            "$1 $2", ["37|4(?:1|5[45]|6[2-4])"], "(8-$1)", "", 0],
        [, "([3-6]\\d{2})(\\d{5})", "$1 $2", ["3[148]|4(?:[24]|6[09])|528|6"], "(8-$1)", "", 0],
        [, "([7-9]\\d{2})(\\d{2})(\\d{3})", "$1 $2 $3", ["[7-9]"], "8 $1", "", 0],
        [, "(5)(2\\d{2})(\\d{4})", "$1 $2 $3", ["52[0-79]"], "(8-$1)", "", 0]
    ],
    ,
    [, , "NA", "NA"],
    ,
    ...
    [, , "6(?:0[0-6]|[14-7]\\d|2[02-46-9]|3[03-8]|8[01]|99)\\d{6}", "\\d{9}", , , "650123456"],
    [, , "80\\d{7}", "\\d{9}", , , "801234567"],
    [, , "89\\d{7}", "\\d{9}", , , "891234567"],
    [, , "NA", "NA"],
    [, , "NA", "NA"],
    ...
    [
        ...
        [, "([58]\\d{3})(\\d{5})",
            "$1-$2", ["5(?:2[2-489]|3[5-9])|892", "5(?:2(?:[2-48]|90)|3(?:[5-79]|80))|892"], "0$1", "", 0],
    ...
    ,
    [, , "[14578]\\d{5,7}|[26]\\d{5,8}|9(?:[258]|3\\d|4\\d{1,2}|[679]\\d?)\\d{6}", "\\d{5,10}"],
    [, , "1(?:2\\d{1,2}|[3-5]\\d|6\\d?|[89][0-6]\\d)\\d{4}|2(?:[236-9]\\d{4}|4(?:0\\d{5}|\\d{4})|5(?:1\\d{3,6}|[02-9]\\d{3,5}))|4(?:2[245-8]|[346][2-6]|5[3-5])\\d{4}|5(?:2(?:20?|[3-8])|3[2-68]|4(?:21?|[4-8])|5[23]|6[2-4]|7[2-8]|8[24-7]|9[2-7])\\d{4}|6(?:0[23]|1[2356]|[24][2-6]|3[24-6]|5[2-4]|6[2-8]|7(?:[2367]|4\\d|5\\d?|8[145]\\d)|8[245]|9[24])\\d{4}|7(?:[04][24-8]|[15][2-7]|22|3[2-4])\\d{4}|8(?:1(?:2\\d?|[3-689])|2[2-8]|3[24]|4[24-7]|5[245]|6[23])\\d{4}",
        "\\d{5,9}", , , "1234567"],
    [, , "17[01]\\d{4}|9(?:2[0-4]|3[136]\\d|4(?:0[0-4]\\d|[1379]\\d|[24][0-589]\\d|5\\d{2}|88)|5[0-6]|61?\\d|73\\d|8\\d|9(?:1\\d|[089]))\\d{5}", "\\d{7,10}", , , "92123456"],
    [, , "NA", "NA"],
    [, , "NA", "NA"],
    [, , "NA", "NA"],
    [, , "NA", "NA"],
    ...
    [
        ...
        [, "(9)(\\d{3})(\\d{4,5})", "$1 $2 $3", ["9(?:[235-9]|4[13789])"], "0$1", "", 0],
    ...
    [
        ...
        [, "(1)([358]\\d)(\\d{4})(\\d{4})", "044 $2 $3 $4", ["1(?:33|55|81)"], "$1", "", 0],
    ...
    ,
    [
        [, "([029]\\d)(\\d{2})(\\d{2})(\\d{2})", "$1 $2 $3 $4", ["[29]|09"], "", "", 0],
    ...
    ,
    [, , "[1-69]\\d{5,8}|[78]\\d{5,13}", "\\d{5,14}"],
    [, , "[12]\\d{6,7}|9\\d{7}|(?:3\\d|4[023568]|5[02368]|6[02-469]|7[4-69]|8[2-9])\\d{6}|(?:4[47]|5[14579]|6[1578]|7[0-357])\\d{5,6}|(?:78|41)\\d{5}",
        "\\d{5,9}", , , "12345678"],
    ...
    NL: [
        ...
        ,
        [
            [, "([1-578]\\d)(\\d{3})(\\d{4})", "$1 $2 $3", ["1[035]|2[0346]|3[03568]|4[0356]|5[0358]|7|8[458]"], "0$1", "", 0],
            [, "([1-5]\\d{2})(\\d{3})(\\d{3})",
        ...
        ,
        [, , "[1-8]\\d{7}|9(?:[1-69]\\d{6}|7[2-6]\\d{5,7}|8\\d{8})", "\\d{6,10}"],
        ...
        ,
        [
            [, "([34679])(\\d{3})(\\d{4})", "$1-$2 $3", ["[3467]|9[1-9]"],
                "0$1", "", 0],
        ...
        [
            [, "(2)(\\d{3})(\\d{4})", "$1 $2 $3", ["2"], "(0$1)", "", 0],
            [, "(\\d{4})(\\d{5})", "$1 $2", ["3(?:23|39|46)|4(?:2[3-6]|[35]9|4[26]|76)|5(?:22|44)|642|8(?:62|8[245])", "3(?:230|397|461)|4(?:2(?:35|[46]4|51)|396|4(?:22|63)|59[347]|76[15])|5(?:221|446)|642[23]|8(?:622|8(?:[24]2|5[13]))"], "(0$1)", "", 0],
        ...
        ,
        [, , "1\\d{8}|[2-8]\\d{5,11}|9(?:[013-9]\\d{4,9}|2\\d(?:111\\d{6}|\\d{3,7}))", "\\d{6,12}"],
        ...
        ,
        [, , "[1-58]\\d{6,8}|9\\d{8}|[67]\\d{5,8}", "\\d{6,9}"],
        ...
        [
            [, "(\\d{2})(\\d{3})(\\d{2})(\\d{2})",
                "$1 $2 $3 $4", ["[124]|3[2-4]|5[24-689]|6[1-3578]|7[14-7]|8[1-79]|9[145]"], "", "", 0],
        ...
        [, , "9(?:61|[78][1-6]|9[1-5])\\d{6}", "\\d{9}", , , "961456789"],
        [, , "NA", "NA"],
        [, , "NA", "NA"],
        [, , "NA", "NA"],
        [, , "NA", "NA"],
        ...
        [
            [, "(\\d{2})(\\d{5,7})", "$1 $2",
                ["(?:[26]1|3[289]|4[124678]|7[123]|8[1236])"], "($1)", "", 0],
        ...
        [, , "(?:11?\\d|2[24-8]|3[35-8]|4[3-68]|6[2-5]|7[235-7])\\d{6}", "\\d{7,9}", , , "112345678"],
        ...
        [
            ...
            [, "([1-69]\\d)(\\d{3})(\\d{2})", "$1-$2 $3",
                ["1[13689]|2[136]|3[1356]|4[0246]|54|6[03]|90"], "0$1", "", 0],
        ...
        [
            ...
            [, "([3-6]\\d{3})(\\d{5})", "$1 $2", ["3(?:5[013-9]|[1-46-8])|4(?:[137][013-9]|6|[45][6-9]|8[4-6])|5(?:[1245][013-9]|6[0135-9]|3|7[4-6])|6(?:[49][013-9]|5[0135-9]|[12][13-8])",
                "3(?:5[013-9]|[1-46-8](?:22|[013-9]))|4(?:[137][013-9]|6(?:[013-9]|22)|[45][6-9]|8[4-6])|5(?:[1245][013-9]|6(?:3[02389]|[015689])|3|7[4-6])|6(?:[49][013-9]|5[0135-9]|[12][13-8])"], "0$1", "", 0]
        ],
        ,
        [, , "NA", "NA"],
        ,
        ...
        ,
        [, , "2(?:[012457-9]\\d{3,8}|6\\d{3,6})|[13-79]\\d{4,8}|8[06]\\d{8}", "\\d{3,10}"],
        ...
        [
            ...
            [, "([2356]\\d{2})(\\d{3,5})", "$1 $2",
                ["2(?:[278]|0[45]|[49]8)|3(?:08|17|3[78]|[78])|5[15][78]|6(?:[29]8|37|[68][78])"], "0$1", "", 0],
...
i18n.phonenumbers.PhoneNumberUtil.prototype.getLengthOfGeographicalAreaCode = function (a) {
    ...
    return null == b || !b.hasNationalPrefix() && !a.hasItalianLeadingZero() || !this.isNumberGeographical(a) ? 0 : this.getLengthOfNationalDestinationCode(a)
};
...
i18n.phonenumbers.PhoneNumberUtil.prototype.formattingRuleHasFirstGroupOnly = function (a) {
    return i18n.phonenumbers.PhoneNumberUtil.FIRST_GROUP_ONLY_PREFIX_PATTERN_.test(a)
};
...
i18n.phonenumbers.PhoneNumberUtil.prototype.format = function (a, b) {
    ...
    var e = this.getRegionCodeForCountryCode(c), f = this.getMetadataForRegionOrCallingCode_(c,
        e), e = this.maybeGetFormattedExtension_(a, f, b), d = this.formatNsn_(d, f, b);
...
i18n.phonenumbers.PhoneNumberUtil.prototype.formatNumberForMobileDialing = function (a, b, c) {
    ...
    if (b == f)b = this.getNumberType(a), e = b == i18n.phonenumbers.PhoneNumberType.FIXED_LINE || b == i18n.phonenumbers.PhoneNumberType.MOBILE || b == i18n.phonenumbers.PhoneNumberType.FIXED_LINE_OR_MOBILE, e = "CO" == f && b == i18n.phonenumbers.PhoneNumberType.FIXED_LINE ?
        ...
        this.format(a, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL) : this.format(a, i18n.phonenumbers.PhoneNumberFormat.NATIONAL); else if (this.canBeInternationallyDialled(a))return c ? this.format(a, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL) : this.format(a, i18n.phonenumbers.PhoneNumberFormat.E164);
...
i18n.phonenumbers.PhoneNumberUtil.prototype.chooseFormattingPatternForNumber_ = function (a, b) {
    for (var c, d = a.length, e = 0; e < d; ++e) {
        ...
        if (0 == f || 0 == b.search(c.getLeadingDigitsPattern(f - 1)))if (f = RegExp(c.getPattern()), i18n.phonenumbers.PhoneNumberUtil.matchesEntirely_(f, b))return c
    }
    return null
};
...
i18n.phonenumbers.PhoneNumberUtil.prototype.isValidNumberForRegion = function (a, b) {
    ...
    return!c.hasNationalNumberPattern() ? (d = e.length, d > i18n.phonenumbers.PhoneNumberUtil.MIN_LENGTH_FOR_NSN_ && d <= i18n.phonenumbers.PhoneNumberUtil.MAX_LENGTH_FOR_NSN_) :
        this.getNumberTypeHelper_(e, d) != i18n.phonenumbers.PhoneNumberType.UNKNOWN
};
...
i18n.phonenumbers.PhoneNumberUtil.prototype.getCountryCodeForRegion = function (a) {
    return!this.isValidRegionCode_(a) ? 0 : this.getCountryCodeForValidRegion_(a)
};
...
i18n.phonenumbers.PhoneNumberUtil.prototype.maybeExtractCountryCode = function (a, b, c, d, e) {
    ...
    if (null != b) {
        ...
        if (goog.string.startsWith(h, g)) {
            ...
            if (!i18n.phonenumbers.PhoneNumberUtil.matchesEntirely_(g, a.toString()) && i18n.phonenumbers.PhoneNumberUtil.matchesEntirely_(g,
                b) || this.testNumberLengthAgainstPattern_(h, a.toString()) == i18n.phonenumbers.PhoneNumberUtil.ValidationResult.TOO_LONG)return c.append(b), d && e.setCountryCodeSource(i18n.phonenumbers.PhoneNumber.CountryCodeSource.FROM_NUMBER_WITHOUT_PLUS_SIGN), e.setCountryCode(f), f
        }
    }
    e.setCountryCode(0);
    return 0
...
i18n.phonenumbers.PhoneNumberUtil.prototype.maybeStripNationalPrefixAndCarrierCode = function (a, b, c) {
    ...
    if (e = g.exec(d)) {
        ...
        if (i18n.phonenumbers.PhoneNumberUtil.matchesEntirely_(f,
            d) && !i18n.phonenumbers.PhoneNumberUtil.matchesEntirely_(f, g))return!1;
...
i18n.phonenumbers.PhoneNumberUtil.prototype.parseHelper_ = function (a, b, c, d) {
    ...
    null != a && (b = new goog.string.StringBuffer, this.maybeStripNationalPrefixAndCarrierCode(f, a, b), c &&
        d.setPreferredDomesticCarrierCode(b.toString()));
    c = f.toString();
    b = c.length;
...
i18n.phonenumbers.PhoneNumberUtil.prototype.buildNationalNumberForParsing_ = function (a, b) {
    ...
    if (0 < c) {
        ...
        b.append(a.substring(a.indexOf(i18n.phonenumbers.PhoneNumberUtil.RFC3966_PREFIX_) + i18n.phonenumbers.PhoneNumberUtil.RFC3966_PREFIX_.length,
            c))
...
i18n.phonenumbers.AsYouTypeFormatter.prototype.inputDigitWithOptionToRememberPosition_ = function (a, b) {
    ...
    switch (this.accruedInputWithoutFormatting_.getLength()) {
        ...
        case 2:
            return this.accruedInput_.toString();
        case 3:
            if (this.attemptToExtractIdd_())this.isExpectingCountryCallingCode_ = !0; else return this.nationalPrefixExtracted_ = this.removeNationalPrefixFromNationalNumber_(), this.attemptToChooseFormattingPattern_();
        default:
...
i18n.phonenumbers.AsYouTypeFormatter.prototype.attemptToFormatAccruedDigits_ = function () {
    for (var a = this.nationalNumber_.toString(), b = this.possibleFormats_.length, c = 0; c < b; ++c) {
        ...
        if (RegExp("^(?:" + e + ")$").test(a))return this.shouldAddSpaceAfterNationalPrefix_ = i18n.phonenumbers.AsYouTypeFormatter.NATIONAL_PREFIX_SEPARATORS_PATTERN_.test(d.getNationalPrefixFormattingRule()), a = a.replace(RegExp(e, "g"), d.getFormat()), this.appendNationalNumber_(a)
    }
    return""
};
...
i18n.phonenumbers.AsYouTypeFormatter.prototype.removeNationalPrefixFromNationalNumber_ = function () {
    ...
    if (this.isNanpaNumberWithNationalPrefix_())b = 1, this.prefixBeforeNationalNumber_.append("1").append(i18n.phonenumbers.AsYouTypeFormatter.SEPARATOR_BEFORE_NATIONAL_NUMBER_), this.isCompleteNumber_ = !0; else if (this.currentMetaData_.hasNationalPrefixForParsing()) {
        ...
        null != c && (null !=
            c[0] && 0 < c[0].length) && (this.isCompleteNumber_ = !0, b = c[0].length, this.prefixBeforeNationalNumber_.append(a.substring(0, b)))
    }
    this.nationalNumber_.clear();
